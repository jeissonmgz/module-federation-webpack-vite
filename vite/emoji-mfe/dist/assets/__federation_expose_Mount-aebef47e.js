...
function useNavigate() {
  let {
    isDataRoute
  } = React$2.useContext(RouteContext); // Conditional usage is OK here because the usage of a data router is static
  // eslint-disable-next-line react-hooks/rules-of-hooks
...
function RenderedRoute(_ref) {
  ...
  let dataRouterContext = React$2.useContext(DataRouterContext); // Track how deep we got in our render pass to emulate SSR componentDidCatch
...
const Link = /*#__PURE__*/React$1.forwardRef(function LinkWithRef(_ref4, ref) {
  ...
  let {
    basename
  } = React$1.useContext(NavigationContext); // Rendered into <a href> for absolute URLs
...
const setBasename = (newBasename) => {basename = newBasename;};

const React = await importShared('react');
const CategoryLazy = React.lazy(() => import('./Category-d972c22e.js'));
const HomeLazy = React.lazy(() => import('./Home-56c6684e.js'));
function App({ basename }) {
  setBasename(basename);
  return /* @__PURE__ */ jsx("div", { className: "App", children: /* @__PURE__ */ jsx(BrowserRouter, { children: /* @__PURE__ */ jsxs(React.Suspense, { fallback: /* @__PURE__ */ jsx("div", { children: "Loading..." }), children: [
    /* @__PURE__ */ jsxs(Routes, { children: [
      /* @__PURE__ */ jsx(Route, { path: `${basename}/tags/:tag?`, element: /* @__PURE__ */ jsx(CategoryLazy, {}) }),
      /* @__PURE__ */ jsx(Route, { path: `${basename}/`, element: /* @__PURE__ */ jsx(HomeLazy, {}) })
    ] }),
    /* @__PURE__ */ jsx("br", {}),
    /* @__PURE__ */ jsx(Link, { to: `${basename}/`, children: "Inicio" }),
    "  |  ",
    /* @__PURE__ */ jsx(Link, { to: `${basename}/tags`, children: "Tags" }),
    /* @__PURE__ */ jsx("br", {})
  ] }) }) });
}

export { jsx as a, useNavigateMfe as b, App as default, jsxs as j, useParams as u };
